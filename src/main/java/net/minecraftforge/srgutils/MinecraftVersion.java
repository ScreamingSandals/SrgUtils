...
public class MinecraftVersion implements Comparable<MinecraftVersion> {
    ...
    @Override
    public int compareTo(@SuppressWarnings("NullableProblems") MinecraftVersion o) {
        if (o == null)
            return 1;
        ...
        switch (this.type) {
            ...
            case BETA:
                ...
                if (this.revision != null && o.revision == null) return -1;
                return Objects.requireNonNull(this.revision).compareTo(Objects.requireNonNull(o.revision));
    ...
    private int compareFull(MinecraftVersion o) {
        ...
        if (this.pre < 0 && o.pre > 0) return 1;
        if (this.pre > 0 && o.pre < 0) return -1;
        return this.pre > 0 ? this.pre - o.pre : -this.pre + o.pre;
    }
